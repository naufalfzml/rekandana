                ...
                <div class="p-6 text-gray-100">
                    ...
                    <div class="space-y-4">
                        @forelse ($pendingProposals as $proposal)
                            <div x-data="{ modalOpen : false }" class="border border-white/10 p-4 rounded-lg flex flex-col sm:flex-row justify-between sm:items-center">
                                <!-- Info Proposal -->
                                <div class="mb-4 sm:mb-0">
                                    <p class="font-bold text-lg">{{ $proposal->title }}</p>
                                    <p class="text-sm text-gray-300">Oleh: {{ $proposal->user->name }} ({{ $proposal->user->university }})</p>
                                    <button @click="modalOpen = true" class="rounded-sm block text-sm mt-2 hover:underline text-indigo-300">
                                        Lihat Detail
                                    </button>
                                </div>
                                                  ...
                                                  <div class="space-y-4">
                                                      ...
                                                      <div class="bg-gradient-to-br from-emerald-900/20 to-teal-900/20 border border-slate-700 rounded-lg p-4">
                                                          ...
                                                          <div class="text-center">
                                                              <span class="text-2xl font-bold text-emerald-300">Rp {{ number_format($proposal->funding_goal) }}</span>
                                                          </div>
                                                      </div>
