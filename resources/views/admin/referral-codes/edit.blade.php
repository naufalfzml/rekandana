                    ...
                    <form method="POST" action="{{ route('admin.referral-codes.update', $referralCode) }}">
                        ...
                        <div class="mt-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500" {{ old('is_active', $referralCode->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                            <p class="text-sm text-gray-600"><strong>Statistik:</strong></p>
                            <p class="text-sm text-gray-600 mt-1">Sudah digunakan oleh: <strong>{{ $referralCode->users_count ?? 0 }}</strong> sponsor</p>
                        </div>
