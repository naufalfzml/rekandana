<x-guest-layout>
    ...
    <div class="w-full sm:max-w-md mt-2 sm:mt-6 px-2 sm:px-6 py-2 sm:py-4 pb-4 sm:pb-0">
        ...
        <a href="{{ route('register.sponsor') }}" class="block w-full text-left p-4 sm:p-5 glass-card neon-border rounded-lg hover:scale-[1.01] transition-transform mb-2 sm:mb-0">
